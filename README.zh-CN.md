...
新版前端统一使用 NutriGenie 品牌标识、更宽的桌面布局、餐食摄影和响应式卡片。公开方案示例使用演示数据；个人方案需要登录后查看。

![NutriGenie 桌面端首页](screenshots/home-desktop.png)

| 方案示例 | 菜谱库 | 创建账户 |
| --- | --- | --- |
| ![移动端只读方案示例](screenshots/demo-mobile.jpg) | ![移动端菜谱库](screenshots/recipes-mobile.jpg) | ![移动端注册页](screenshots/auth-mobile.jpg) |

## 核心功能

- **用户与饮食画像**：支持注册、登录，以及身体数据、活动水平、健康目标、饮食类型、过敏原和忌口管理；每份新方案可单独设置预算。
