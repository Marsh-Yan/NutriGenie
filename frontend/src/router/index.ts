...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      meta: { requiresAuth: true, requiresAdmin: true, title: '管理概览' },
    },
    {
      path: '/admin/ingredients',
      name: 'admin-ingredients',
      component: () => import('@/views/AdminIngredientsPage.vue'),
      meta: { requiresAuth: true, requiresAdmin: true, title: '食材管理' },
    },
    { path: '/admin/recipes', name: 'admin-recipes', component: () => import('@/views/AdminRecipesPage.vue'), meta: { requiresAuth: true, requiresAdmin: true, title: '菜谱管理' } },
    { path: '/admin/knowledge', name: 'admin-knowledge', component: () => import('@/views/AdminKnowledgePage.vue'), meta: { requiresAuth: true, requiresAdmin: true, title: '知识库管理' } },
    {
      path: '/:pathMatch(.*)*',
      name: 'not-found',
